...
export function helpText(options: SlashCommandOptions = {}): string {
  ...
  return [
    ...
    "/research-experiments [status] [limit]",
    "/research-approve <experiment_id> [notes]",
    "/research-execute <experiment_id>",
    "/research-chat [--model <model>] <message>",
    "/research-nightly [limit]",
    "/agent <id> (or /agents)",
